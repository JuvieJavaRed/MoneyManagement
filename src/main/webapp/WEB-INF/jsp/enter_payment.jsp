        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row" id="validation">
					...
					<div class="col-md-6">
                                                <div class="form-group">
                                                   <label for="wemailAddress2"> Date : <span class="danger">*</span> </label>
                                                    <input type="date" class="form-control required" id="wemailAddress2" name="date"> 
                                            </div>
                                        </div>
                                        </div>
                                    <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wemailAddress2"> Receipt Number : <span class="danger">*</span> </label>
                                                    <input type="text" class="form-control required" id="wemailAddress2" name="inflowid"> </div>
                                            </div>
					<div class="col-md-6">
                                                <div class="form-group">
