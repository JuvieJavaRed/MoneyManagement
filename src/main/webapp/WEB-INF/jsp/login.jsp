<%-- 
    Document   : login
    Created on : 12 Dec 2018, 3:20:19 PM
    Author     : Rodney
--%>
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="resources/assets/images/logo-light-icon.png">
...
<body>
    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(../assets/images/background/login-register.jpg);">        
            ...
            <div class="card-body">
                <form class="form-horizontal form-material" method="post" id="loginform" action="${pageContext.request.contextPath}/login">
