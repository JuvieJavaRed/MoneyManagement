<%-- 
    Document   : view_employee_transaction
    Created on : 26 May 2019, 1:16:44 PM
    Author     : Rodney
--%>
                    ...
                    <div class="col-md-4">
                        <div class="card card-inverse" style="background-color: #333; border-color: #333;">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Bookings In 24 Hours</h4></div>
                            <div class="card-body">
                                <h3 class="card-title">The total number of bookings in the last 24 Hours is:</h3>
                                <h1 class="card-text">30</h1>
                                <a href="#" class="btn btn-primary">Generate Custom Report</a>
                            </div>
                        </div>
                    </div>
					 <div class="col-md-4">
                        <div class="card card-inverse" style="background-color: #333; border-color: #333;">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Total Bookings</h4></div>
                            <div class="card-body">
                                <h3 class="card-title">Total Number of Bookings Made By The System</h3>
					 ...
					 <div class="col-md-4">
                        <div class="card card-inverse" style="background-color: #333; border-color: #333;">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Bookings Moved</h4></div>
                            <div class="card-body">
                                <h3 class="card-title">Total Bookings Moved By The System Is:</h3>
                                <h1 class="card-text">23 </h1>
                                <a href="#" class="btn btn-primary">Generate Custom Report</a>
                            </div>
                        </div>
                    </div>
